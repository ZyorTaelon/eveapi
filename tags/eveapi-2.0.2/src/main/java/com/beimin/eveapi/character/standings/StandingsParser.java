...
public class StandingsParser extends AbstractStandingsParser<StandingsResponse> {
	...
	protected Digester getDigester() {
		...
		digester.addObjectCreate("eveapi/result/standingsTo/rowset/row", ApiStandingTo.class);
		...
		digester.addObjectCreate("eveapi/result/standingsFrom/rowset/row", ApiStandingFrom.class);
