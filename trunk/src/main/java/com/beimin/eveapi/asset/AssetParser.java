...
public class AssetParser extends AbstractApiParser<AssetResponse> {
	protected static final String ASSETLIST_URL = "/AssetList.xml.aspx";

	public AssetParser() {
		super(AssetResponse.class, 2, ASSETLIST_URL);
	}
	...
	public AssetResponse getAssets(ApiAuth auth, boolean corporation) throws IOException, SAXException {
		if (corporation)
			return getResponse(auth, Path.CORP);
		return getResponse(auth, Path.CHARACTER);
	}

	public static AssetParser getInstance() {
