...
public class StarbaseListParser extends AbstractListParser<StarbaseListResponse, ApiStarbase> {
	public StarbaseListParser() {
		super(StarbaseListResponse.class, 2, ApiPath.CORPORATION, ApiPage.STARBASE_LIST, ApiStarbase.class);
	}
