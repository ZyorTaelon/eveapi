...
public class StandingsParser extends AbstractStandingsParser<StandingsResponse> {
	...
	protected Digester getDigester() {
		...
		digester.addObjectCreate(
				"eveapi/result/corporationStandings/standingsTo/rowset",
				StandingsList.class);
		digester.addSetProperties("eveapi/result/corporationStandings/standingsTo/rowset");
		digester.addObjectCreate(
				"eveapi/result/corporationStandings/standingsTo/rowset/row",
				ApiStandingTo.class);
		...
		digester.addSetNext(
				"eveapi/result/corporationStandings/standingsTo/rowset",
				"addCorporationStandingsToList");

		digester.addObjectCreate(
				"eveapi/result/corporationStandings/standingsFrom/rowset",
				StandingsList.class);
		digester.addSetProperties("eveapi/result/corporationStandings/standingsFrom/rowset");
		digester.addObjectCreate(
				"eveapi/result/corporationStandings/standingsFrom/rowset/row",
				ApiStandingFrom.class);
		...
		digester.addSetNext(
				"eveapi/result/corporationStandings/standingsFrom/rowset",
				"addCorporationStandingsFromList");

		digester.addObjectCreate(
				"eveapi/result/allianceStandings/standingsTo/rowset",
				StandingsList.class);
		digester.addSetProperties("eveapi/result/allianceStandings/standingsTo/rowset");
		digester.addObjectCreate(
				"eveapi/result/allianceStandings/standingsTo/rowset/row",
				ApiStandingTo.class);
		digester.addSetProperties("eveapi/result/allianceStandings/standingsTo/rowset/row");
		digester.addSetNext(
				"eveapi/result/allianceStandings/standingsTo/rowset/row", "add");
		digester.addSetNext(
				"eveapi/result/allianceStandings/standingsTo/rowset",
				"addAllianceStandingsToList");

		digester.addObjectCreate(
				"eveapi/result/allianceStandings/standingsFrom/rowset",
				StandingsList.class);
		digester.addSetProperties("eveapi/result/allianceStandings/standingsFrom/rowset");
		digester.addObjectCreate(
				"eveapi/result/allianceStandings/standingsFrom/rowset/row",
				ApiStandingFrom.class);
