...
public class KillLogParser extends AbstractApiParser<KillLogResponse> {
	...
	public KillLogResponse getKillList(ApiAuth auth, boolean corporation) throws IOException, SAXException {
		if (corporation)
