...
public class TitlesParser extends AbstractListParser<TitlesHandler, TitlesResponse, TitleWithRoles> {
    public TitlesParser() {
        super(TitlesResponse.class, 2, ApiPath.CORPORATION, ApiPage.TITLES, TitlesHandler.class);
    }

    @Override
    public TitlesResponse getResponse(final ApiAuth auth) throws ApiException {
